            ...
            function ($routeProvider, $locationProvider) {
                ...
                $routeProvider
                    ...
                    .when('/comments/:skip?/:limit?', {
                        ...
                        templateUrl: 'app/views/comments.html<&= tail("root/app/views/comments.html") &>',
                        access: {requireLogin: true}
                    })
                    .when('/user/:id?', {
                        controller: 'UserCtrl',
                        templateUrl: 'app/views/user.html<&= tail("root/app/views/user.html") &>',
                        access: {requireLogin: true}
                    })
                    .when('/users/:skip?/:limit?', {
                        controller: 'UsersCtrl',
                        templateUrl: 'app/views/users.html<&= tail("root/app/views/users.html") &>',
                        access: {requireLogin: true}
                    })
                    .when('/role/:id?', {
                        controller: 'RoleCtrl',
                        templateUrl: 'app/views/role.html<&= tail("root/app/views/role.html") &>',
                        access: {requireLogin: true}
                    })
                    .when('/roles/:skip?/:limit?', {
                        controller: 'RolesCtrl',
                        templateUrl: 'app/views/roles.html<&= tail("root/app/views/roles.html") &>',
                        access: {requireLogin: true}
                    })
                    .when('/setting/:id?', {
                        controller: 'SettingCtrl',
                        templateUrl: 'app/views/setting.html<&= tail("root/app/views/setting.html") &>',
                        access: {requireLogin: true}
                    })
                    .when('/settings/:skip?/:limit?', {
                        controller: 'SettingsCtrl',
                        templateUrl: 'app/views/settings.html<&= tail("root/app/views/settings.html") &>',
                        access: {requireLogin: true}
                    })
                    .otherwise({
                        redirectTo: '/'
